...
const MyPortfolio = () => {
  ...
  const gotToGithub=()=>{
    const url = 'https://github.com/Kamlesh-Panwar';
    ...
    <section className='portfolio--section' id='MyPortfolio'>
        <div className='portfolio--container-box'>
            <div className='portfolio--container'>
                {/* <p className='sub--title'>Portfolio Section</p>  */}
                <h2 className='section--heading'>Projects Section</h2>
           </div>
           <div>
           <button className="btn btn-github" onClick={gotToGithub}>
            <svg
        ...
        <div className='portfolio--section--container'>
            {data?.portfolio?.map((itm,idx)=>{
                return(
                    <div key={idx} className='portfolio--section--card'>
                        <div className='portfolio--section--img'>
                            <img src={itm?.src} alt="img" style={{borderRadius:"10px 10px 0px 0px"}} />
                        </div>
                        <div className='portfolio--section--card--content'>
                            <div className='project--description'>
                                <h3 className='portfolio--section--title'>{itm.title}</h3>
                                <p className='text-md'>{itm.description}</p>
                            </div>
                            {/* <p className='text-sm portfolio--link'> */}
                                <button className='go--to--github--button' >
                                {/* {itm.link}   onClick={()=>{window.open(`${itm.link}` , '_blank');}} */}
                                  Go to Github
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  width="16"
